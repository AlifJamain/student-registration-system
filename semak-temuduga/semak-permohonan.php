    ...
    ?><tr>
                                                        <td>
                                                            <?php $stats=$result->Status;
                                                                  $stat=$result->TemudugaKelayakan;
                                                                  $statz=$result->SekolahKelayakan1;
                                                                  if($stats==1 && $stat=='Maahad Johor - Lelaki Sahaja'){
                                                            ?>
                                                            <center><p><b><span style="color: green">Berjaya</span></b></p></center>
                                                            <center><a href="print.php" class="btn btn-primary">Cetak</a></center>
                                                            <?php } if($stats==1 && $stat=='SMA Kerajaan Johor, Kluang' && $statz=='Maahad Johor Lil Banat (Ditempatkan di SMAKJ - Perempuan Sahaja)'){
                                                            ?>
                                                            <center><p><b><span style="color: green">Berjaya</span></b></p></center>
                                                            <center><a href="print.php" class="btn btn-primary">Cetak</a></center>
                                                            <?php } if($stats==1 && $stat=='SMA Kerajaan Johor, Kluang' && $statz=='SMA Kerajaan Johor, Kluang'){
                                                            ?>
                                                            <center><p><b><span style="color: green">Berjaya</span></b></p></center>
                                                            <center><a href="print.php" class="btn btn-primary">Cetak</a></center>
                                                            <?php } if($stats==1 && $stat=='Maahad Pontian, Pontian'){
                                                            ?>
                                                            <center><p><b><span style="color: green">Berjaya</span></b></p></center>
                                                            <center><a href="print.php" class="btn btn-primary">Cetak</a></center>
                                                            <?php } if($stats==1 && $stat=='SMA Parit Raja, Batu Pahat'){
                                                            ?>
                                                            <center><p><b><span style="color: green">Berjaya</span></b></p></center>
                                                            <center><a href="print.php" class="btn btn-primary">Cetak</a></center>
                                                            <?php }  if($stats==1 && $stat=='SMA Bugisiah Tampok, Benut, Pontian'){
                                                            ?>
                                                            <center><p><b><span style="color: green">Berjaya</span></b></p></center>
                                                            <center><a href="print.php" class="btn btn-primary">Cetak</a></center>
                                                            <?php }
