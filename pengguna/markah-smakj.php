                     ...
                     <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title">Sekolah Menengah Agama Kerajaan Johor</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-12">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Sekolah Menengah Agama Kerajaan Johor</li>
            						</ul>
                                </div>
  ...
  <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="submit" class="btn btn-success btn-labeled">Submit<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                            <a href="pemohonan-smakj.php" class="btn btn-danger btn-labeled">Kembali<span class="btn-label btn-label-right"><i class="fa fa-close"></i></span></a>
                                                    </div>
