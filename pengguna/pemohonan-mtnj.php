        ...
        <div class="main-wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-container">
                    ...
                    <?php include('includes/leftbar-mtnj.php');?>  
...
<?php 
        ...
        $sql = "SELECT kelayakan.IdKelayakan, pemohon.NamaPemohon, pemohon.KadPengenalanPemohon,pemohon.IdPemohon as lid, kelayakan.output as result, kelayakan.TemudugaKelayakan, markah.HafazanMarkah, markah.BertulisMarkah, markah.QuranMarkah, markah.output from kelayakan join pemohon on kelayakan.pemid=pemohon.IdPemohon join markah on markah.pemid=pemohon.IdPemohon where kelayakan.TemudugaKelayakan=:pid order by lid ASC";
...
<td>
<a href="markah-mtnj.php?IdPemohon=<?php echo htmlentities($result->lid);?>"><i class="fa fa-edit" title="Edit Record"></i> </a> 
