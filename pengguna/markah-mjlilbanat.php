                     ...
                     <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title">Maahad Johor Lilbanat (SMAKJ)</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-12">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Maahad Johor Lilbanat (SMAKJ)</li>
            						</ul>
                                </div>
  ...
  <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="submit" class="btn btn-success btn-labeled">Submit<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                            <a href="pemohonan-mjlilbanat.php" class="btn btn-danger btn-labeled">Kembali<span class="btn-label btn-label-right"><i class="fa fa-close"></i></span></a>
                                                    </div>
...
function calculate()
            {
                ...
                var d=document.getElementById("QuranMarkah").value;
                var total = ((a/1) - (- (b/1)) - (- (d/1)));
                var total2 = (total*(100)/300).toFixed(1);
