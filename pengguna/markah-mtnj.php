...
if(strlen($_SESSION['mtnjlogin'])=="") {   
    header("Location: index.php"); 
} else {
    $pid=$_SESSION['mtnjlogin'];
    $lid=intval($_GET['IdPemohon']);
    if(isset($_POST['submit']))
    { 
        $HafazanMarkah=$_POST['HafazanMarkah'];
        $BertulisMarkah=$_POST['BertulisMarkah'];
        $QuranMarkah=$_POST['QuranMarkah'];
        $output=$_POST['output'];
        $sql="UPDATE markah SET HafazanMarkah=:HafazanMarkah, BertulisMarkah=:BertulisMarkah, QuranMarkah=:QuranMarkah, output=:output WHERE pemid=:lid";
        $query = $dbh->prepare($sql);
        $query->bindParam(':HafazanMarkah',$HafazanMarkah,PDO::PARAM_STR);
                     ...
                     <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title">Maahad Tahfiz Negeri Johor</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-12">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Maahad Tahfiz Negeri Johor</li>
            						</ul>
                                </div>
...
<div class="alert alert-success left-icon-alert" role="alert">
 <strong>Tahiah!</strong><?php echo htmlentities($msg); ?>
 </div><?php } 
else if($error){?>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Markah Hafazan</label>
                                                		<div class="">
                                                			<input type="text" name="HafazanMarkah" class="form-control" required="required" id="HafazanMarkah" onchange="calculate()" >
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
  ...
  <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="submit" class="btn btn-success btn-labeled">Submit<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                            <a href="pemohonan-mtnj.php" class="btn btn-danger btn-labeled">Kembali<span class="btn-label btn-label-right"><i class="fa fa-close"></i></span></a>
                                                    </div>
...
function calculate()
            {
                var a=document.getElementById("HafazanMarkah").value;
                ...
                //var total5 = b / 50;
                //var total6 = c / 50;
                var total7 = (total - ( - total2) - ( - total3)).toFixed(1);
