        ...
        <div class="main-wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-container">
                    ...
                    <?php include('includes/leftbar-mp.php');?>  
                    
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Maahad Pontian</h2>
                                </div>
                            </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Maahad Pontian</li>
            						</ul>
                                </div>
                            </div>
                        </div>
...
<td>
<a href="markah-mp.php?IdPemohon=<?php echo htmlentities($result->lid);?>"><i class="fa fa-edit" title="Edit Record"></i> </a> 
