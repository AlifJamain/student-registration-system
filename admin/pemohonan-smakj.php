                    ...
                    <div class="main-page">
                        ...
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title">Sekolah Menengah Agama Kerajaan Johor, Kluang</h2>
                                </div>
                            </div>
                            <div class="row breadcrumb-div">
                                <div class="col-md-12">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Sekolah Menengah Agama Kerajaan Johor, Kluang</li>
            						</ul>
                                </div>
                            </div>
                            <div class="row breadcrumb-div">
