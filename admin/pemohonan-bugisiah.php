                    ...
                    <div class="main-page">
                        ...
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title">Sekolah Menengah Agama Bugisiah Tampok, Benut, Pontian</h2>
                                </div>
                            </div>
                            <div class="row breadcrumb-div">
                                <div class="col-md-12">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Sekolah Menengah Agama Bugisiah Tampok, Benut, Pontian</li>
            						</ul>
                                </div>
                            </div>
                            <div class="row breadcrumb-div">
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php 
        $sql = "SELECT kelayakan.IdKelayakan as lid, pemohon.NamaPemohon, pemohon.KadPengenalanPemohon,pemohon.IdPemohon, pemohon.Status, kelayakan.output, kelayakan.TemudugaKelayakan, kelayakan.PPSR from kelayakan join pemohon on kelayakan.pemid=pemohon.IdPemohon where kelayakan.TemudugaKelayakan='SMA Bugisiah Tampok, Benut, Pontian' order by lid asc";
