                ...
                <div class="content-container">
                    ...
                    <div class="main-page">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <center><button type="submit" name="submit" class="btn btn-primary">Terima</button></center>
                                </div>
                                <div class="col-md-6">
                                    <center><button type="submit" name="reject" class="btn btn-danger">Tolak</button></center>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php 
        $sql = "SELECT pemohon.*, kelayakan.*, markah.output as result from pemohon join kelayakan on pemohon.IdPemohon=kelayakan.pemid join markah on markah.pemid=pemohon.IdPemohon where pemohon.Status=1 ORDER BY kelayakan.PPSR ASC, kelayakan.output ASC, markah.output ASC";
