                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php 
        $sql = "SELECT pemohon.*, kelayakan.*, markah.output as result from pemohon join kelayakan on pemohon.IdPemohon=kelayakan.pemid join markah on markah.pemid=pemohon.IdPemohon where pemohon.Status=2";
...
<td>
<a href="pemohonan-ditolak.php?IdPemohon=<?php echo htmlentities($result->IdPemohon);?>" onclick="confirm('Permohonan Diterima');"><i class="fa fa-check" title="Acticvate Record"></i></a>&nbsp;&nbsp;&nbsp;<a href="pemohonan-ditolak.php?pemid=<?php echo htmlentities($result->IdPemohon);?>" onclick="confirm('Permohonan Ditolak');"><i class="fa fa-times" title="Deactivate Record"></i> </a>
